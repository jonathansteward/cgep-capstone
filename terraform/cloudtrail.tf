######################################################################
# Layer 1 — Audit trail (adapted from cgep Lab 5.2).
# Multi-region, log-file validation, KMS-encrypted.
# SOC 2 CC7.2 — proves controls operated over time (Type II evidence).
######################################################################
